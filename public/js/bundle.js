...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ3VpdXNtdWl1cyIsImEiOiJja2kzY2YxdHExbXBmMzRvYWhqdmRlNHF5In0.SEvbE7RThI6AkNhNywNPZw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/guiusmuius/cki3co0496iyt19quztx48un1',
    scrollZoom: false //   center: [-118.353646, 34.070716],
    //   zoom: 6,
    //   interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toLowerCase(), " changed successfully!"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51HydMQIEfZ5VJaFcoPRDIbksZQNfQTlXDPZ97p65qeyzjDWPUl1JTYQpbM3I2Ph9xHpIdjslIRnH6cWwT4ubZE2G00YLOVy6z8');
