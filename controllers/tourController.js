...
exports.resizeTourImages = catchAsync(async (req, res, next) => {
  ...
  req.body.images = [];
  await Promise.all(
    // we use map so that we can save the result of the 3 promises (result of the 3 following async functions) so that we can await the result of these 3 async functions
...
// '/tours-within/:distance/center/:latlong/:unit'
// 34.298004,-118.630115
